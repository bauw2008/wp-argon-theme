...
switch ($argon_assets_path) {
    case "jsdelivr":
      $GLOBALS['assets_path'] = "https://cdn.jsdelivr.net/gh/bauw2008/wp-argon-theme@" . $argon_version;
        break;
    case "fastgit":
      $GLOBALS['assets_path'] = "https://raw.fastgit.org/bauw2008/wp-argon-theme/v" . $argon_version;
        break;
    case "sourcegcdn":
      $GLOBALS['assets_path'] = "https://gh.sourcegcdn.com/bauw2008/wp-argon-theme/v" . $argon_version;
        break;
  case "jsdelivr_gcore":
      $GLOBALS['assets_path'] = "https://gcore.jsdelivr.net/gh/bauw2008/wp-argon-theme@" . $argon_version;
        break;
  case "jsdelivr_fastly":
      $GLOBALS['assets_path'] = "https://fastly.jsdelivr.net/gh/bauw2008/wp-argon-theme@" . $argon_version;
        break;
  case "jsdelivr_cf":
      $GLOBALS['assets_path'] = "https://testingcf.jsdelivr.net/gh/bauw2008/wp-argon-theme@" . $argon_version;
        break;
  case "custom":
...
switch ($argon_update_source) {
  ...
  case "github":
    default:
    $argonThemeUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
      'https://raw.githubusercontent.com/bauw2008/wp-argon-theme/master/info.json',
      get_template_directory() . '/functions.php',
      'argon'
    );
}
...
function argon_get_post_thumbnail($postID = 0){
  ...
  if (has_post_thumbnail($postID)){
    ...
    if ($thumbnail) {
      return apply_filters("argon_post_thumbnail", $thumbnail[0]);
    }
  }
