...
<div id="float_action_buttons" class="float-action-buttons fabtns-unloaded">
  ...
  <button id="fabtn_go_to_comment" class="btn btn-icon btn-neutral fabtn shadow-sm d-none" type="button" <?php if (get_option('argon_fab_show_gotocomment_button') != 'true') echo " style='display: none;'";?> aria-label="Comment" tooltip="<?php _e('评论', 'argon'); ?>">
	...
	<button id="fabtn_menu_wpadminbar" class="btn btn-icon btn-neutral fabtn shadow-sm" type="button" aria-label="Admin Menu" tooltip="<?php _e('后台', 'argon'); ?>">
    <span class="btn-inner--icon"><i class="fa fa-wordpress"></i></span>
</button>

<!-- 对话框 -->
<div id="adminMenuDialog" class="dialog-container" title="工具栏内容">
