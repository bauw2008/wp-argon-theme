...
<script src="<?php bloginfo('template_url'); ?>/assets/vendor/jquery/jquery.min.js"></script>
	...
	<div>
		...
		<p style="margin-top: 20px;">
			<a href="https://github.com/bauw2008/wp-argon-theme/" target="_blank" style="box-shadow: none;text-decoration: none;">
				...
				<span style="font-size: 20px;transform: translate(5px,-9px);display: inline-block;">bauw2008/wp-argon-theme</span>
			</a>
		</p>
